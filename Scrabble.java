...
public class Scrabble {
	...
	public static String createHand() {
		int handWithoutVowels = HAND_SIZE - 2;

		String randomLetters = MyString.randomStringOfLetters(handWithoutVowels);
		String handWithVowel1 = MyString.insertRandomly('a', randomLetters);
		handWithVowel1 = MyString.insertRandomly('e', handWithVowel1);

		return handWithVowel1;
	}
